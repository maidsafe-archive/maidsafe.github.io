...
Roadmap.prototype.highlightList = function(source, fromBox) {
  var self = this;
  if (fromBox) {
    var taskId = self.getTaskIdForBox(source);
    source = '#' + taskId;
  }
