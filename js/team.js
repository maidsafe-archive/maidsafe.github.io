...
var fraserBio = "Further to studying computing science at University, Fraser&rsquo;s diverse range of experience has seen him serve 14 years with the Oxfordshire Fire Brigade and Strathclyde Fire and Rescue in addition to 10 years as a director of a service business. Fraser has been a member of the MaidSafe team since 2009. Fraser is married and has a son. At weekends he enjoys programming, hillwalking and playing football.";
...
var peterBio = "Peter is one of our remote C++ programmers. Fascinated by special effects in movies and video games, he started his programming career in an early age and completed his Msc in math, computer graphics and computer science. After some years of experience in the computer graphics field, his attention moved to network programming which was required for a game he was working on in a team of two. Surprised by the complexity of asynchronous programming he soon found his new fascination in a search for patterns that make such code behave.";
var leeBio = "Lee has a B.S. and M.S. in Computer Science from Virginia Tech, and 5 years of professional C++ experience. His graduate work focused on security in software and computer networking, which is still one of his primary interests along with crypto-currencies. Lee is also an enthusiast for the open source C++ project Boost, where he happily hacks in any component involving metaprogramming.";
var shonaBio = "Shona has an HND in Graphic Design and is part of the User Experience team. She previously spent 3 years working for a creative agency and has been with MaidSafe since 2011. Her favourite things include family movie nights, aerial silks, Instagram, doing handstands, chewing fruit gums and hosting tea parties.";
